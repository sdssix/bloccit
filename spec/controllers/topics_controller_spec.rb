...
RSpec.describe TopicsController, type: :controller do
  let (:my_topic) { Topic.create!(name: RandomData.random_sentencess, description: RandomData.random_paragraph) }
  ...
  context "guest" do
    ...
    describe "POST #create" do
      it "returns http redirect" do
        post :create, topic: {name: RandomData.random_sentences, description: RandomData.random_paragraph}
        expect(response).to redirect_to(new_session_path)
      end
    end
    ...
    describe "PUT #update" do
      it "returns http redirect" do
        new_name = RandomData.random_sentences
  ...
  context "admin" do
    ...
    describe "POST #create" do
      it "increases the number of topics by 1" do
        expect{ post :create, {topic: {name: RandomData.random_sentences, description: RandomData.random_paragraph}}}.to change(Topic,:count).by(1)
      end
